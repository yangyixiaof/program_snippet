			...
			if (!last_dns.isEmpty()) {
				...
				while (litr.hasNext()) {
					...
					if (!last_dn.IsSameGroup(new_dn)) {
						// TODO Serious bug! The child node may be created before the parent node.
						// TODO The reason is that the new_node is not created after all its in_connections been visited.
